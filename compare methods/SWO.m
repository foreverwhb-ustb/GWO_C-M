...
function [Best_score,Best_SW,Convergence_curve]=SWO(SearchAgents_no,Tmax,ub,lb,dim,fhd)
...
%%---------------Initialization----------------------%%
%%
Positions=initialization(SearchAgents_no,ub,lb,dim); % Initialize the positions of spider wasps
t=0; %% Function evaluation counter 

%%---------------------Evaluation-----------------------%%
for i=1:SearchAgents_no
    %% Test suites of CEC-2014, CEC-2017, CEC-2020, and CEC-2022
    SW_Fit(i)=feval(fhd, Positions(i,:));
...
Convergence_curve(1,t-1)=Best_score;
end
