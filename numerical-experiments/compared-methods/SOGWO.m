...
function [Alpha_pos,Alpha_score,Convergence_curve]=SOGWO(SearchAgents_no,dim,ub,lb,fobj,Max_iter)
...
x=initialization(SearchAgents_no,ub,lb,dim);
...
while l<Max_iter
    ...
    threshold=a;
    x=corOppose(x,fitness,ub,lb,upper,lower,dim,threshold);
    ...
    l=l+1;
    Convergence_curve(1,l)=Alpha_score;
end
end
